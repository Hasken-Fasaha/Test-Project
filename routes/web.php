...
Route::post('/course/create', [_CourseController::class, 'store'])->name(
    'coursecreate'
);
Route::get('/course/delete/{id}', [_CourseController::class, 'destroy'])->name(
    'coursedestroy'
);

Route::get('/faculty', [_FacultyController::class, 'index'])->name('faculty');
Route::get('/faculty/edit/{id}', [_FacultyController::class, 'edit']);
Route::post('/faculty/edit', [_FacultyController::class, 'update'])->name(
    'facultyupdate'
);
Route::post('/faculty/create', [_FacultyController::class, 'store'])->name(
    'facultycreate'
);
Route::get('/faculty/delete/{id}', [
    _FacultyController::class,
    'destroy',
])->name('facultydestroy');

Route::get('/department', [_DepartmentController::class, 'index'])->name(
    'department'
);
Route::get('/department/edit/{id}', [_DepartmentController::class, 'edit']);
Route::post('/department/edit', [_DepartmentController::class, 'update'])->name(
    'departmentupdate'
);
Route::post('/department/create', [
    _DepartmentController::class,
    'store',
])->name('departmentcreate');
Route::get('/department/delete/{id}', [
    _DepartmentController::class,
    'destroy',
])->name('departmentdestroy');

Route::get('/payment', [_PaymentHistoryController::class, 'index'])->name(
    'payment'
);
Route::get('/payment/edit/{id}', [_PaymentHistoryController::class, 'edit']);
Route::post('/payment/edit', [
    _PaymentHistoryController::class,
    'update',
])->name('paymentupdate');
...
Route::get('/programme', [_ProgramController::class, 'index'])->name(
    'programme'
);
Route::get('/programme/edit/{id}', [_ProgramController::class, 'edit']);
Route::post('/programme/edit', [_ProgramController::class, 'update'])->name(
    'programmeupdate'
);
Route::post('/programme/create', [_ProgramController::class, 'store'])->name(
    'programmecreate'
);
Route::get('/programme/delete/{id}', [
    _ProgramController::class,
    'destroy',
])->name('programmedestroy');

Route::get('/profile', [_ProfileController::class, 'index'])->name('profile');
Route::get('/profile/edit/{id}', [_ProfileController::class, 'edit']);
Route::post('/profile/edit', [_ProfileController::class, 'update'])->name(
    'profileupdate'
);
Route::post('/profile/create', [_ProfileController::class, 'store'])->name(
    'profilecreate'
);
Route::get('/profile/delete/{id}', [
    _ProfileController::class,
    'destroy',
])->name('profiledestroy');
Route::get('/profile/delete/{id}', [
    _ProfileController::class,
...
Route::post('/student/edit', [_StudentController::class, 'update'])->name(
    'studentupdate'
);
Route::post('/student/create', [_StudentController::class, 'store'])->name(
    'studentcreate'
);
Route::get('/student/delete/{id}', [
    _StudentController::class,
    'destroy',
])->name('studentdestroy');
...
Route::prefix('students')->group(function () {
    Route::get('/admissions', [_AdmissionController::class, 'index'])->name(
        'admissions.index'
    );
    Route::post('/admission/store', [
        _AdmissionController::class,
        'store',
    ])->name('admission.store');
    Route::get('/admissions/fetchAll', [
        _AdmissionController::class,
        'fetchAll',
    ])->name('admissions.fetchAll');
    Route::delete('/admission/delete', [
        _AdmissionController::class,
        'delete',
    ])->name('admission.delete');
    Route::get('/admission/edit', [_AdmissionController::class, 'edit'])->name(
        'admission.edit'
    );
    ...
    Route::get('/grades', [_GradeController::class, 'index'])->name(
        'grades.index'
    );
    Route::post('/grade/store', [_GradeController::class, 'store'])->name(
        'grade.store'
    );
    Route::get('/grades/fetchAll', [_GradeController::class, 'fetchAll'])->name(
        'grades.fetchAll'
    );
    Route::delete('/grade/delete', [_GradeController::class, 'delete'])->name(
        'grade.delete'
    );
    Route::get('/grade/edit', [_GradeController::class, 'edit'])->name(
        'grade.edit'
    );
    Route::post('/grade/update', [_GradeController::class, 'update'])->name(
        'grade.update'
    );

    Route::get('/results', [_AdmissionController::class, 'index']);
    Route::post('/result/store', [_AdmissionController::class, 'store'])->name(
        'result.store'
    );
    Route::get('/results/fetchAll', [
        _AdmissionController::class,
        'fetchAll',
    ])->name('results.fetchAll');
    Route::delete('/result/delete', [
        _AdmissionController::class,
        'delete',
    ])->name('result.delete');
    Route::get('/result/edit', [_AdmissionController::class, 'edit'])->name(
        'result.edit'
    );
    Route::post('/result/update', [
        _AdmissionController::class,
        'update',
    ])->name('result.update');

    Route::get('/tuitions', [_TuitionDetailController::class, 'index'])->name(
        'tuitions.index'
    );
    Route::post('/tuition/store', [
        _TuitionDetailController::class,
        'store',
    ])->name('tuition.store');
    Route::get('/tuitions/fetchAll', [
        _TuitionDetailController::class,
        'fetchAll',
    ])->name('tuitions.fetchAll');
    Route::delete('/tuition/delete', [
        _TuitionDetailController::class,
        'delete',
    ])->name('tuition.delete');
    Route::get('/tuition/edit', [
        _TuitionDetailController::class,
        'edit',
    ])->name('tuition.edit');
    Route::post('/tuition/update', [
        _TuitionDetailController::class,
        'update',
    ])->name('tuition.update');

    Route::get('/tuitions-detail', [
        _TuitionDescriptionController::class,
        'index',
    ])->name('tuitions-detail.index');
    Route::post('/tuition-detail/store', [
        _TuitionDescriptionController::class,
        'store',
    ])->name('tuition-detail.store');
    Route::get('/tuitions-detail/fetchAll', [
        _TuitionDescriptionController::class,
        'fetchAll',
    ])->name('tuitions-detail.fetchAll');
    Route::delete('/tuition-detail/delete', [
        _TuitionDescriptionController::class,
        'delete',
    ])->name('tuition-detail.delete');
    Route::get('/tuition-detail/edit', [
        _TuitionDescriptionController::class,
        'edit',
    ])->name('tuition-detail.edit');
    Route::post('/tuition-detail/update', [
        _TuitionDescriptionController::class,
        'update',
    ])->name('tuition-detail.update');

    Route::get('/acceptance', [_PaymentController::class, 'index'])->name(
        'acceptance.index'
    );
...
Route::prefix('student')->group(function () {
    Route::get('/landing-page', [_LandingPageController::class, 'index'])->name(
        'landing.index'
    );
});
...
Route::post('/biodata/edit', [_BiodataController::class, 'update'])->name(
    'biodataupdate'
);
Route::post('/biodata/create', [_BiodataController::class, 'store'])->name(
    'biodatacreate'
);
Route::get('/biodata/delete/{id}', [
    _BiodataController::class,
    'destroy',
])->name('biodatadestroy');

Route::get('/session', [_SessionController::class, 'index'])->name('session');
Route::get('/session/edit/{id}', [_SessionController::class, 'edit']);
Route::post('/session/edit', [_SessionController::class, 'update'])->name(
    'sessionupdate'
);
Route::post('/session/create', [_SessionController::class, 'store'])->name(
    'sessioncreate'
);
Route::get('/session/delete/{id}', [
    _SessionController::class,
    'destroy',
])->name('sessiondestroy');
