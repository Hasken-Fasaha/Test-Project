                    ...
                    <tbody>
                        @foreach ($faculties as $item )
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" data-id="{{$item->faculty_id}}" id="" class=" facultyedit btn btn-primary waves-effect waves-light">
                                            <i class="bx bx-pencil font-size-16 align-middle me-2"></i> 
                                        </button>

                                        <button type="button" data-id="{{$item->faculty_id}}" id="" class=" facultydelete btn btn-danger waves-effect waves-light">
