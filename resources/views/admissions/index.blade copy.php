        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddStudentModalLabel">Add Admission Data</h5>
                    ...
                    <div class="card-header">
                        <h4>
                            ...
                            <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal"
                                data-bs-target="#AddStudentModal">Add Admission</button>
                        </h4>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchAdmission() {
                $.ajax({ ///students/fetch-admissions
                    type: "GET",
                    url: "{{ route('admissions.fetchAdmission') }}",
                    dataType: "json",
                    success: function(response) {
                        console.log(response);
                        $('tbody').html("");
                        $.each(response.admissions, function(key, item) {
                            $('tbody').append(
                                '<tr>\
                                                                                                                                                        <td>' +
                                item
