    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="pull-right">
               ...
               <br>
<button type="button" class="btn btn-primary" id="btnid" data-toggle="modal" data-target="#exampleModalCenter">
  Create New Course
</button>
...
<form id="form1" action="{{ route('course.store') }}" method="POST">
    ...
    <input list="levels" name="level" id="level"  placeholder="Which Level?" /></label>
    <datalist id="levels">
        ...
        <tr>
            ...
            <td>
                <form action="" method="POST">
                    <a class="btn btn-info  btnshow"   >Show</a>
