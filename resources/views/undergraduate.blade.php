            ...
            <div class="container-fluid">
              ...
              <div class="row justify-content-center">
                <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
                  ...
                  <a href="#" class="logo me-auto me-lg-0"><img src="{{ asset('assets/images/ngit.png') }}" alt="" class="img-fluid"></a>
        
                   <nav id="navbar" class="navbar order-last order-lg-0">
                   <ul>
                      <li><a class="nav-link scrollto active" href="index.php#hero">Home</a></li>
                      {{-- <li><a class="nav-link scrollto" href="index.php#about">How it works</a></li>
                      <li><a class="nav-link scrollto" href="index.php#contact">Contact</a></li>
                      <li><a class="nav-link scrollto" href="index.php#services">Support</a></li>
                      <li><a class="nav-link scrollto" href="index.php#faq">FAQs</a></li> --}}
                    </ul>
                    <i class="bi bi-list mobile-nav-toggle"></i>
                  </nav><!-- .navbar -->
        
                  <a class="get-started-btn scrollto"  href="#">
        <i class="bi bi-download"></i> Admission Archive</a>
                </div>
              </div>
